...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OCRD" Or strTab = "OINS" Or strTab = "OINV" Or strTab = "OHEM" Or strTab = "ODLN" Or strTab = "OITM" Or strTab = "OINV" Or strTab = "ORDR") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            addField("OITM", "CEC", "Customer Equipment Card", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            AddFields("ODLN", "EndCustomer", "End Customer", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("OINS", "QTY", "Quantity", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Quantity)
            '  addField("INV1", "CEC", "Customer Equipment Card", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            AddTables("Z_OATT", "Attribute Mater", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddTables("Z_OCECATT", "CEC Attribute Mater", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("Z_OCECATT", "Z_DocEntry", "CEC Document Entry", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("Z_OCECATT", "Z_DocNum", "CEC Document Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OCECATT", "Z_Code", "Attribute Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_OCECATT", "Z_Desc", "Attribute Description", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_OCECATT", "Z_ItemCode", "Item Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("Z_OCECATT", "Z_SerialNo", "Internal Serial Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OCECATT", "Z_CardCode", "Customer Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("Z_OCECATT", "Z_manufSN", "Mfr.SerialNo", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
