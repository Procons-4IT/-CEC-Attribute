Public Class clsStart
    ...
    Shared Sub Main()
        ...
        Try
            ...
            omenu = oApplication.SBO_Application.Menus.Item("Z_mnu_Bl002")
            omenu.Image = Application.StartupPath & "\DataBest.bmp"
            oApplication.Utilities.Message("CEC Integration Addon Connected successfully", SAPbouiCOM.BoStatusBarMessageType.smt_Success)
