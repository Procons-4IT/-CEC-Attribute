Public Module modVariables
    ...
    Public Const mnu_CECAttribute As String = "Z_mnu_Bl002"
    Public Const frm_CECAttribute As String = "frm_CECAttribute"
    Public Const xml_CECAttribute As String = "xml_CECAttribute.xml"

    Public Const frm_CEC As String = "60150"
